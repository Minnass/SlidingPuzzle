...
import random
import time
from GameSettings.util import ImageDivider, Image
from GameSettings.Board import Board
from enum import Enum
from GameSettings.UIElement import *
from solver import *
...
class Game():
    ...
    def draw(self):
        ...
        if(self.Mode==Mode.HUMAN_MODE):
            ...
            Label(GAME_SIZE*TILESIZE+TILESIZE ,TILESIZE,f"Total Step: {self.Algorithm.steps}" ).draw(self.screen)
        pygame.display.flip()
    ...
    def run(self):
        while True:
            ...
            if self.isPlaying and self.Mode!=Mode.SOLVER_MODE:
